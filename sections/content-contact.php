	<section class="contact" id="<?php echo $slug ?>">
    ...
    <form id="form-work" class="" name="form-work" action="#">
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="district">Inquiry</label>
          ...
          <div class="form-group">
            <div class="col-md-12">
              <button type="button" class="btn btn-primary btn-lg btn-block info" style="background-color:	#BEADC0 !important;">Send</button>
            </div>
          </div>     
      </fieldset> 
    </form>
